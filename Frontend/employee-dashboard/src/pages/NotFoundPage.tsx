  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-slate-50 text-slate-800 p-6">
      <div className="text-center max-w-md">
        <h1 className="text-9xl font-extrabold text-indigo-600 tracking-widest font-heading">404</h1>
        <div className="bg-emerald-500 text-white px-2 py-1 text-sm rounded rotate-12 absolute -mt-16 ml-36">
          Page Not Found
        </div>
        <h2 className="text-2xl font-bold mt-8 text-slate-900 font-heading">Looks like you're lost</h2>
